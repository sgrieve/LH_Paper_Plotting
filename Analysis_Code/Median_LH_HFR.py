...
Method to plot a histogram of median hillslope length data from the 
*_PaperData.txt file generated by LH_Driver.cpp
...
plt.savefig(figpath+'Median_LH.png', dpi = 500) #change to *.tif for submission
