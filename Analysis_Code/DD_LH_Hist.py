...
Method to plot a histogram of hillslope length data from drainage denisty data
from the *_PaperData.txt file generated by LH_Driver.cpp
...
path = '..\\..\\Final_Data\\smooth\\' #path to the folder contaning the paperdata files
filename = 'NC_PaperData.txt' #names of the PaperData files
...
plt.vlines(np.median(DD),0,ymax,label='Median', color='r',linewidth=1,linestyle='dashed')
...
plt.savefig(figpath+'DD_LH_Hist.png', dpi = 500) #change to *.tif for submission
