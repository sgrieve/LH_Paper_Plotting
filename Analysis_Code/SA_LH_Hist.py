...
Method to plot a histogram of hillslope length data from slope-area plots
from the  *_PaperData.csv file generated by LH_Driver.cpp
...
filename = 'NC_PaperData.txt'#name of the PaperData files
...
plt.savefig(figpath+'SA_LH_Hist.png', dpi = 500) #change to *.tif for submission
