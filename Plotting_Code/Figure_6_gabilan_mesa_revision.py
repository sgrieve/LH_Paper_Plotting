...
Script to generate Figure 6 from Grieve et al. (2015)
...
path = 'C:/Users/Stuart/Dropbox/LH_Paper/gm/' #path to the folder contaning the hilltopdata files
filename = 'GM_PaperData.txt'#names of the hilltopdata file
...
# title
fig.text(0.5, 0.925, 'Gabilan Mesa', ha='center', va='center', size=14)
...
plt.savefig(figpath+'Figure_6.png', dpi = 500) #change to *.tif for submission
